...
def generate_launch_description():
    ...
    launch_file_lidar2d_0 = '/workspace/husky-sim/husky_config/sensors/launch/lidar2d_0.launch.py'
    launch_file_camera_0 = '/workspace/husky-sim/husky_config/sensors/launch/camera_0.launch.py'
    launch_file_imu_0 = '/workspace/husky-sim/husky_config/sensors/launch/imu_0.launch.py'
    launch_file_gps_0 = '/workspace/husky-sim/husky_config/sensors/launch/gps_0.launch.py'
